...
public class FhRecordDianServiceImpl extends BaseServiceImp<FhRecordDian, Integer> implements
	...
	@Autowired
	private DianpuForUserService dianForUserService;
	@Autowired
...
//				dianForUser.setUseryId(fromUserId);
...
//	}
	...
	@Override
	public String fahongbao(String wxOpenid, Integer userId, Integer userId2, Integer level, Integer amount,
			Integer flagCount) {
	...
	@Override
	public String bufahongbao(String wxOpenid, Integer userId, Integer userId2, Integer level, Integer amount,
			Integer flagCount) {
		// TODO Auto-generated method stub
		return null;
	}
