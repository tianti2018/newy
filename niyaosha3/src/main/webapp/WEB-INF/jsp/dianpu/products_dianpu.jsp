...
<div id="topsearchbar" class="wx_search wx_search_chanel_mode wx_search_nian wx_search_promote_ex">
	...
	<div class="banner">
		<div class="flexslider">
			<ul class="slides">
				<c:forEach var="product" items="${lunbos}" varStatus="vstatus">
					<li onclick="javascript:chooseUrl(5,${product.id });">
						<img style="height: 400px" src="${product.headUrl}" />
					</li>
				</c:forEach>
			</ul>
		</div>
...
function shwoCity(){
	...
	<div class="wet_bnr " id="topTonglan">
		<c:forEach items="${dankuans}" var="product" varStatus="status">
			<div class="item">
				<a href="javascript:chooseUrl(5,${product.id });" class="url">
					<img style="" src="${product.headUrl }" alt="">
				</a>
			</div>
		...
		<div class="wet_section" id="cnxhShow">
			...
			<div class="wet_pro_panel wet_pro_v2_panel">
				...
				<div class="wet_pro_list">
					<c:forEach var="product" items="${sanlies }" varStatus="status">
						<div class="item">
							<a href="javascript:chooseUrl(5,${product.id });" class="url">
								<div class="img">
