...
<div class="wet_bnr " id="topTonglan">
  <div class="item"><a href="javascript:chooseUrl(5,2);" class="url"><img style="width: 100%" src="<%=request.getContextPath()%>/images/miaosha/mianmo/mm32.jpg" alt="" ></a></div>
  <div class="wet_space size_s btm"></div>
    <div class="item"><a href="javascript:chooseUrl(5,49);" class="url"><img style="width: 100%" src="<%=request.getContextPath()%>/images/miaosha/shuiguangzhen/shuiguangzhenhengfu.jpg" alt="" ></a></div>
  <div class="wet_space size_s btm"></div>
</div>
         <div class="wet_spe_panel">
            ...
            <div class="spe_span span_r">
                ...
                <a href="#" class="s_col brand_col" onclick="chooseUrl(5,94)">
                    ...
                    <div class="img"> 
                        <img src="<%=request.getContextPath()%>/images/miaosha/yangshengyi/a1.jpg" >
                    </div>
                    </div>
                </a>
                <a href="#" class="s_col" onclick="chooseUrl(5,93)">
                    ...
                    <div class="img">
                        <img src="<%=request.getContextPath()%>/images/miaosha/qinangzhen/a1.jpg" >
                    </div>
                    </div>
                </a>
            </div>
         ...
         <div class="wet_spe_panel">
            ...
            <div class="spe_span span_r">
                ...
                <a href="#" class="s_col brand_col" onclick="chooseUrl(5,96)">
                    ...
                    <div class="img"> 
                        <img src="<%=request.getContextPath()%>/images/miaosha/yaobao/a1.jpg" >
                    </div>
                    </div>
                </a>
                <a href="#" class="s_col" onclick="chooseUrl(5,97)">
                    ...
                    <div class="img">
                        <img src="<%=request.getContextPath()%>/images/miaosha/lengfengzuodian/a1.jpg" >
                    </div>
                    </div>
                </a>
            </div>
         ...
         <div class="wet_spe_panel">
            ...
            <div class="spe_span span_r">
                ...
                <a href="#" class="s_col brand_col" onclick="chooseUrl(5,82)">
                    ...
                    <div class="img"> 
                        <img src="<%=request.getContextPath()%>/images/miaosha/jiayongjinghuaqi/a2.jpg" >
                    </div>
                    </div>
                </a>
                <a href="#" class="s_col" onclick="chooseUrl(5,52)">
                    ...
                    <div class="img">
                        <img src="<%=request.getContextPath()%>/images/miaosha/huoliku/tuibuhuawen/tuibuhuawena2.jpg" >
                    </div>
                    </div>
                </a>
            </div>
