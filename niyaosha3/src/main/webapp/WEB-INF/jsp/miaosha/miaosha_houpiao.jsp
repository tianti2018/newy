...
<div class="banner_box">
	<div class="banner">
		<a href="#" ontouchmove="shows(1)">
			<img src="<%=request.getContextPath()%>/images/miaosha/houpiao/hou1.jpg" >
		</a>
		<a href="#" ontouchmove="shows(2)">
			<img src="<%=request.getContextPath()%>/images/miaosha/houpiao/hou2.jpg" >
		</a>
		<a href="#" ontouchmove="shows(3)">
			<img src="<%=request.getContextPath()%>/images/miaosha/houpiao/hou3.jpg" >
		</a>
		<a href="#" ontouchmove="shows(4)">
			<img src="<%=request.getContextPath()%>/images/miaosha/houpiao/hou4.jpg" >
		</a>  
	</div>
</div>
	<div class="div-xinxi">
		<ul>
			<li>产品：朝鲜2013年猴年整版80枚全新 雕刻版 大版票 外国邮票  价格:150元</li>
			...
			<li><img style="width: 100%" alt="" src="<%=request.getContextPath()%>/images/miaosha/houpiao/01.jpg"></li>
			<li><img style="width: 100%" alt="" src="<%=request.getContextPath()%>/images/miaosha/houpiao/02.jpg"></li>
			<li><img style="width: 100%" alt="" src="<%=request.getContextPath()%>/images/miaosha/houpiao/03.jpg"></li>
			<li><img style="width: 100%" alt="" src="<%=request.getContextPath()%>/images/miaosha/houpiao/04.jpg"></li>
			<li><img style="width: 100%" alt="" src="<%=request.getContextPath()%>/images/miaosha/houpiao/05.jpg"></li>
			<%-- <li><img style="width: 100%" alt="" src="<%=request.getContextPath()%>/images/miaosha/houpiao/06.jpg"></li> --%>
			<li><img style="width: 100%" alt="" src="<%=request.getContextPath()%>/images/miaosha/houpiao/07.jpg"></li>
	...
	function dianji(a){
		...
		/* alert("升级维护中！"); */
			...
			$.ajax({
		        type:"POST",
		        url:"<%=request.getContextPath()%>/pay/payGoodAction!saveHouMS.action",
		        data : {
...
//   	 	       alert("支付失败!");  
	...
	<div class="ft-but">
		<p class="xx-J">共￥<span id="jiage" class="xx-jia">165</span>元,含运费15元</p>
