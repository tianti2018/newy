...
<script type="text/javascript">
	...
	function searchClic() {
		...
		frmSearch.action="search!listCount.action?methodFlag=all";
		frmSearch.submit();
...
<body onload="body_onload();">
	...
	<div class="rhead">
		<div class="rpos">您的当前位置: 逃费车辆管理-->逃费车辆高级查询</div>
		<div class="clear"></div>
	</div>
	...
	<b>功能简介：</b> <br>
	   ...
	   &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;    本模块可根据时间、逃费方式、车牌号、挖掘参数名称等条件灵活组合查询由数据挖掘模型挖掘出来的逃费车辆信息。<br>  
	 选择”逃费方式”下拉框中的某一逃费方式，再选择“挖掘参数名称”下拉框中的某一挖掘参数名称，页面右侧可显示这一逃费方式的详细挖掘参数配置信息。<br>  
            选择相应的查询条件，点击“查询”按钮，页面下方将显示出查询结果信息，如：入口时间、逃费方式、挖掘参数名称、出口车牌号、逃费次数、明细信息等信息，<br>  
	 点击查询结果信息中的“明细”字段，还可显示这一车辆的详细信息；还可在查询条件“车牌号”内输入要查询的车牌号，点击“查询”按钮，查询该车牌号的结果信息。 <br> 
	 点击“Excel报表打印”按钮，可将查询的结果信息全部导出。点击“进入逃费车辆详细查询界面“，可灵活组合查询条件，<br> 
	 如：逃费方式、起止日期、入口分中心、入口收费站、出口分中心、出口收费站、收费员、车牌号、挖掘参数名称等查询逃费车辆信息，<br>
	 还可根据需要进行组合排序，便于查询相关数据信息；对查询的结果可进行录入黑名单、排除嫌疑、Excel报表打印等操作。 
	...
	<div class="rhead">
  	...
  	<div class="rhead">
  		<a href="search!listAllOne.action?methodFlag=init" target="rightIFrame"> >>进入逃费车辆详细查询页面</a>			
  	</div>
...
<form id="frmSearchOne" name="frmSearchOne" method="post">
   ...
   <c:if test="${not empty litPager}">
		 ...
		 <c:param name="pageActionUrl" value="search!listCount.action"/>
