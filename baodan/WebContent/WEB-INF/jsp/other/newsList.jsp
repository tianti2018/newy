...
<script language="javascript" type="text/javascript">
	...
	function deleteNews() {
		if(confirm('您确定删除吗？')) {
			self.location.href="news!delete.action?newsId="+arguments[0];	
			return true;	
		}
		return false;
	}
...
<body onload="body_onload();">
	<div class="body-box">
	<div class="rhead">
		<div class="rpos">您的当前位置: 信息管理-->公告管理</div>
		<div class="clear"></div>
	</div>
	<div class="rhead">
		<form class="ropt" method="post">
			&nbsp; <input type="button" value="新增公告" onclick="addNews();"/>
		</form>
		<div class="clear"></div>
	</div>
	<table class="pn-ltable" width="100%" cellspacing="1" cellpadding="0" border="0">
		...
		<tbody class="pn-ltbody">
			...
			<tr onmouseover="Pn.LTable.lineOver(this);" onmouseout="Pn.LTable.lineOut(this);">
				...
				<td class="pn-lopt"><a href="news!initModify.action?newsId=${item.newsId}&&currentPage=<s:property value="pager.currentPage"/>" class="pn-loperator">修改</a></td>
				<td class="pn-lopt"><a href="javascript:void(0);" onclick="deleteNews('${item.newsId}');" class="pn-loperator">删除</a></td>
			</tr>
		</c:forEach>   
		</tbody>
	</table>
    ...
    <c:if test="${not empty litPager}">
     <c:import url="/WEB-INF/jsp/page/page.jsp">
     	<c:param name="pageActionUrl" value="news!listAll.action"/>
     </c:import>
    </c:if>
