...
<form id="frmOrder" name="frmOrder" method="post" action="orders!create.action" >
	...
	<table width="100%" class="pn-ftable" cellpadding="2" cellspacing="1" border="0">
		...
		<tr>
		  ...
		  <td width="80%" class="pn-fcontent">
		  	<input type="text" id="mobile" value="${order.mobile }" name="mobile" size="20" maxlength="20" onblur="checkTel('mobile');"/>
		...
		<tr>
		  ...
		  <td width="80%" class="pn-fcontent">
		  	<input type="text" id="address" value="${order.address }" name="address" size="20" maxlength="20" onblur="checkTextArea()"/>
