...
<script type="text/javascript">
	...
	function saveOrUpdate() {
		var currNumInput = document.getElementById("currNum");	
		var currNum = currNumInput.value;
		...
		frmOrder.action = "egg!updateShiTouNum.action";			
		frmOrder.submit();
...
<div class="body-box">
<div class="rhead">
		<div class="rpos">您的当前位置: 财务管理-->修改免费极地独山石数量</div>
		<div class="clear"></div>
	</div>
...
<form id="frmOrder" name="frmOrder" method="post"  >
	...
	<table width="100%" class="pn-ftable" cellpadding="2" cellspacing="1" border="0">
		...
		<tr>
			<td width="20%" class="pn-flabel pn-flabel-h">剩余数量：</td>
			<td width="80%" class="pn-fcontent">${eau.currNum}</td>
		</tr>
		<tr>
			<td width="20%" class="pn-flabel pn-flabel-h">修改数量：</td>
			<td><input type="text" id="currNum" name="currNum" /></td>
		</tr>
		<tr>
			<td colspan="2" class="pn-fbutton"><input type="button" id="cmdButton" onclick="return saveOrUpdate();" value="修改"/></td>
		</tr>
	</table>
</form>
</div>
