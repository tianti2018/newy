	...
	<table width="100%" class="pn-ftable" cellpadding="2" cellspacing="1" border="0">
		...
		<tr>
		  ...
		  <td width="80%" class="pn-fcontent">
		  	<input type="text" id="toUserName" value="" name="toUserName" size="20" maxlength="20"/><font color="red">*</font>
		  </td>
		</tr>
		...
		<tr>
			...
			<input type="hidden" id="sheng" name="sheng" value=""/>
		  <td width="80%" class="pn-fcontent">
		...
		<tr>
			...
			<input type="hidden" id="chengshi" name="chengshi" value=""/>
		  <td width="80%" class="pn-fcontent">
		...
		<tr>
			...
			<input type="hidden" id="diqu" name="diqu" value=""/>
		  <td width="80%" class="pn-fcontent">
		...
		<tr>
		  ...
		  <td width="80%" class="pn-fcontent">
		  	<input type="text" id="address" value="" name="address" size="200" maxlength="200" style="width: 90%" onblur="checkTextArea()"/>
		...
		<tr>
		  ...
		  <td width="80%" class="pn-fcontent">
		  	<input type="text" id="zipcode" value="" name="zipcode" size="20" maxlength="20"/>
		  </td>
		</tr>
		<tr>
			<td width="20%" class="pn-flabel pn-flabel-h">水果名称：</td>
		  <td width="80%" class="pn-fcontent">
		  	<input type="text" id="pname" value="" name="pname" size="20" maxlength="20" />
		  	<font color="red">*</font>
		  </td>
		</tr>
		<tr>
		  ...
		  <td width="80%" class="pn-fcontent">
		  	<input type="text" id="shuliang" value="" name="shuliang" size="20" maxlength="20" onblur="checkShuLiang()"/>
		...
		<tr>
		  ...
		  <td width="80%" class="pn-fcontent">
		  	<input type="text" id="size" value="" name="size" size="20" maxlength="20" />
		  	<font color="red">*</font>
		  </td>
		</tr>
		<tr>
		  ...
		  <td width="80%" class="pn-fcontent">
		  	<input type="text" id="money" value="" name="money" size="20" maxlength="20" onblur="checkJinE()"/>
