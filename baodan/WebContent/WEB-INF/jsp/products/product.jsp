						...
						<div class="pro-color">
							...
							<c:if test="${typeqty>0}">
								<c:forEach var="p" items="${typelist}" varStatus="vstatus">
									<a id="xuanze_${p.productsId}" class="xuanze" name="product" guige="${p.guige}" stock="${p.stock}"
							...
							<c:if test="${typeqty==0}">
								<a id="xuanze_${prod.productsId}" class="xuanze" name="product" guige="${prod.guige}" stock="${prod.stock}"
