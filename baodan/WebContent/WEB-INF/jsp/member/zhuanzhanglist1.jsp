...
<body onload="body_onload();">
	<div class="body-box">
	<div class="rhead">
		<div class="rpos">您的当前位置: 我的奖金转报单币记录</div>
		<div class="clear"></div>
	</div>
	<div class="rhead">
	...
	<form id ="frmzz" name="frmzz" action="user!jiangjinzhuandianzibi.action" class="ropt" method="post">
		转入积分:<input type="text"   id="fhMoney" name="fhMoney"/>
		<input type="button" value=" 转账  " onclick="check();" />
	</form>
	<div class="clear"></div>
</div>
  ...
  <!-- 导入分页组件  -->
   <c:if test="${not empty litPager}">
     <c:import url="/WEB-INF/jsp/page/page.jsp">
    	  <c:param name="pageActionUrl" value="user!initjiangjinzhuanbaodanbi.action"/>
     </c:import>
   </c:if>
