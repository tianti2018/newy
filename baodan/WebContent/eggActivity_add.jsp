...
<body onload="alertMes();">
	...
	<s:form namespace="/admin" action="eggActivity!saveEntity.action"
		...
		<div class="formbody">
			...
			<ul class="forminfo">
				...
				<li><label><b style="color: #f00;">*</b>&nbsp;活动名称：</label><input
					name="eggActivity.activityName" datatype="uum2-128" nullMsg="请填写活动名称" errorMsg="请输入6~128位汉字/数字/字母/"
				...
				<li><label><b style="color: #f00;">*</b>&nbsp;活动结束时间：</label> <input
					name="endTime" datatype="*" nullMsg="请填写秒杀开始时间"
					type="text" class="Wdate" id="endTime"
				...
				<textarea name="eggActivity.activityContent" id="content" rows="15" cols="155"></textarea></li>
		...
		<table style="margin-left: 30px;margin-top:20px"  class="tablelist" id="tableListFirst">
			...
			<tr>
				...
				<td><input
					...
					type="text" class="inputxt"/>
					<font
					class="Validform_checktip">请输入2~128位字符串</font>
					</td>
						<td></td>
			</tr>
		</table>
