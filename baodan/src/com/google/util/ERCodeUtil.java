...
{
	//二维码图片路径
	private static final String ERCODE_PATH = "E:\\nginx\\html\\qrload";
	private static final String ERCODE_URL="http://118.244.151.182:9898/qrload/";
...
//		FileUtil.mkdirs(destPath);
	...
	public static void main(String[] args) throws Exception {
		String text = "http://www.jilianji.com?loginName=maomao_998";
	...
	public  static String createQRcode(String text,String logoPic,String codePic,Boolean logoCompress){
		...
		String savePath=ERCODE_PATH;
		 ...
		 File dir = new File(savePath);
	        ...
	        try {
				ERCodeUtil.encode(text, "", savePath, false);
			} catch (Exception e) {
