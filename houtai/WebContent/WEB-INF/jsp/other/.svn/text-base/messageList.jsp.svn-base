...
<script language="javascript" type="text/javascript">
	...
	function deleteMessage() {
		if(confirm('您确定删除吗？')) {
			self.location.href="message!delete.action?messageId="+arguments[0];	
			return true;	
		}
		return false;
	}
...
<body onload="body_onload();">
	<div class="body-box">
	<div class="rhead">
		<div class="rpos">您的当前位置: 市场管理-->我要留言</div>
		<div class="clear"></div>
	</div>
	<div class="rhead">
		<form class="ropt" method="post">
			&nbsp; <input type="button" value="新增留言" onclick="addMessage();"/>
		</form>
		<div class="clear"></div>
	</div>
	<table class="pn-ltable" width="100%" cellspacing="1" cellpadding="0" border="0">
		...
		<tbody class="pn-ltbody">
			...
			<tr onmouseover="Pn.LTable.lineOver(this);" onmouseout="Pn.LTable.lineOut(this);">
				...
				<td class="pn-lopt"><a href="message!initModify.action?messageId=${item.messageId}&&currentPage=<s:property value="pager.currentPage"/>" class="pn-loperator">修改</a></td>
    ...
    <c:if test="${not empty litPager}">
     <c:import url="/WEB-INF/jsp/page/page.jsp">
     	<c:param name="pageActionUrl" value="message!listAll.action"/>
     </c:import>
    </c:if>
