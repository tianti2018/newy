...
<script language="javascript" type="text/javascript">
	...
	loadSearch =function () {
		...
		self.location.href="user!listAllzhuanruzhuanchu.action?loginName="+loginName;	
	}
...
<body onload="body_onload();">
	<div class="body-box">
	<div class="rhead">
		<div class="rpos">您的当前位置: 财务管理-->会员转入转出查询</div>
		<div class="clear"></div>
	</div>
	<div class="rhead">
	...
	<table class="pn-ltable" width="100%" cellspacing="1" cellpadding="0" border="0">
		...
		<tbody class="pn-ltbody">
			...
			<tr onmouseover="Pn.LTable.lineOver(this);" onmouseout="Pn.LTable.lineOut(this);" onclick="Pn.LTable.lineSelect(this);">
				...
				<td align="center">
					<c:if test="${item.fhType =='7'}">电子转账--转出</c:if>
					<c:if test="${item.fhType =='8'}">电子转账--转入</c:if>
				</td>
  ...
  <!-- 导入分页组件  -->
   <c:if test="${not empty litPager}">
     <c:import url="/WEB-INF/jsp/page/page.jsp">
    	  <c:param name="pageActionUrl" value="user!listAllzhuanruzhuanchu.action"/>
     </c:import>
   </c:if>
