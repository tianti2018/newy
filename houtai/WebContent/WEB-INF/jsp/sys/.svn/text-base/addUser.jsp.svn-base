	...
	<table width="100%" class="pn-ftable" cellpadding="2" cellspacing="1" border="0">
		...
		<td width="20%" class="pn-flabel pn-flabel-h">用户密码：</td>
		  <td width="80%" class="pn-fcontent">
		  	...
		  	<font color="red">(注意: 修改的时候不输入默认为原密码)</font>
		  </td>
		</tr>
		...
		<tr>
		  ...
		  <td width="80%" class="pn-fcontent">
		  	<input type="password" id="confirmPWD" name="confirmPWD"  onblur="checkPw('confirmPWD');" size="20" maxlength="12" />
		  </td>
		</tr>
		...
		<tr>
		  ...
		  <td width="80%" class="pn-fcontent">
		  	<input type="text" id="phone" name="phone"   value="${requestScope.user.phone}"  size="20"  maxlength="30"/>
		  </td>
		</tr>
