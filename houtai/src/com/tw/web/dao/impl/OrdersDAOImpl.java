	...
	public Double zong_li_run(String j_fromDate, String j_endDate) throws ParseException  {
		...
		if(orders.size()>0){
			for(Orders o:orders){
				...
				User u = o.getUser();
				if(u!=null){
					User refUser1 = u.getReferrer();
					if(refUser1 != null){
						bilv+=Double.valueOf(SystemConfigUtil.getString("levelOne"));
						User refUser2 = refUser1.getReferrer();
						if(refUser2!=null){
							bilv+=Double.valueOf(SystemConfigUtil.getString("levelTwo"));
							User refUser3 = refUser2.getReferrer();
							if(refUser3!= null){
								bilv+=Double.valueOf(SystemConfigUtil.getString("levelThr"));
							}
						}
					}
				}
