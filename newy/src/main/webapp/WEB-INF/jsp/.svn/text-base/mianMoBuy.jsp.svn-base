...
<body>
		...
		<div class="banner_box">
			<div class="banner">
				...
				<a href="#" ontouchmove="shows(1)">
					<img src="<%=request.getContextPath()%>/images/miaosha/mianmo/mm3banner.jpg" style="width: 100%">
				</a>
				</c:if>
				...
				<a href="#" ontouchmove="shows(4)">
					<img src="<%=request.getContextPath()%>/images/miaosha/neiyi/hongse/ny1banna.jpg" style="width: 100%">
				</a>
				</c:if>
				
				<c:if test="${prod.prodType==7}">
				<a href="#" ontouchmove="shows(3)">
					<img src="<%=request.getContextPath()%>/images/miaosha/neiyi/heise/ny2banna.jpg" style="width: 100%">
				</a>
				</c:if>
				
				<c:if test="${prod.prodType==8}">
				<a href="#" ontouchmove="shows(3)">
					<img src="<%=request.getContextPath()%>/images/miaosha/neiyi/fense/ny3banna.jpg" style="width: 100%">
				</a>
				</c:if>
				...
				<a href="#" ontouchmove="shows(3)">
					<img src="<%=request.getContextPath()%>/images/miaosha/yanzhao/yanzhao.jpg" style="width: 100%">
				</a>
				</c:if>
				
				<c:if test="${prod.prodId==39}">
				<a href="#" ontouchmove="shows(3)">
					<img src="<%=request.getContextPath()%>/images/miaosha/wsj/wsjbanna.jpg" style="width: 100%">
				</a>
				</c:if>
				<c:if test="${prod.prodId==40}">
				<a href="#" ontouchmove="shows(3)">
					<img src="<%=request.getContextPath()%>/images/miaosha/cha/gushuhongcha/hongchabanna.jpg" style="width: 100%">
				</a>
				</c:if>
				<c:if test="${prod.prodId==41}">
				<a href="#" ontouchmove="shows(3)">
					<img src="<%=request.getContextPath()%>/images/miaosha/cha/puer/puerbanna.jpg" style="width: 100%">
				</a>
				</c:if>
				<c:if test="${prod.prodId==49}">
				<a href="#" ontouchmove="shows(3)">
					<img src="<%=request.getContextPath()%>/images/miaosha/shuiguangzhen/shuiguangzhen_banna.jpg" style="width: 100%">
				</a>
				</c:if>
					<c:if test="${prod.prodId==50}">
				<a href="#" ontouchmove="shows(3)">
					<img src="<%=request.getContextPath()%>/images/miaosha/huoliku/shuizuan/banna.jpg" style="width: 100%">
				</a>
				</c:if>
				<c:if test="${prod.prodId==51}">
				<a href="#" ontouchmove="shows(3)">
					<img src="<%=request.getContextPath()%>/images/miaosha/huoliku/tu an/banna.jpg" style="width: 100%">
				</a>
				</c:if>
				<c:if test="${prod.prodId==52}">
				<a href="#" ontouchmove="shows(3)">
					<img src="<%=request.getContextPath()%>/images/miaosha/huoliku/tuibuhuawen/banna.jpg" style="width: 100%">
				</a>
				</c:if>
				<c:if test="${prod.prodId==53}">
				<a href="#" ontouchmove="shows(3)">
					<img src="<%=request.getContextPath()%>/images/miaosha/kebeieryanwenxiao/banna.jpg" style="width: 100%">
				</a>
				</c:if>
				<c:if test="${prod.prodId==54}">
				<a href="#" ontouchmove="shows(3)">
					<img src="<%=request.getContextPath()%>/images/miaosha/guanjieling/banna.jpg" style="width: 100%">
				</a>
				</c:if>
				<c:if test="${prod.prodId==55}">
				<a href="#" ontouchmove="shows(3)">
					<img src="<%=request.getContextPath()%>/images/miaosha/jingzhuibao/banna.jpg" style="width: 100%">
				</a>
				</c:if>
				<c:if test="${prod.prodId==56}">
				<a href="#" ontouchmove="shows(3)">
					<img src="<%=request.getContextPath()%>/images/miaosha/yaoshudai/banna.jpg" style="width: 100%">
				</a>
				</c:if>
				<c:if test="${prod.prodId==59}">
				<a href="#" ontouchmove="shows(3)">
					<img src="<%=request.getContextPath()%>/images/miaosha/neiyi/heiseduankuan/banna.jpg" style="width: 100%">
				</a>
				</c:if>
			     <c:if test="${prod.prodId==81}">
				<a href="#" ontouchmove="shows(3)">
					<img src="<%=request.getContextPath()%>/images/miaosha/nameibojinduotai/banna.jpg" style="width: 100%">
				</a>
				</c:if>
			...
			<div class="price">
				<p>购物车总计</p>
				   ...
				   <span> 库存：<c:out value="${p.stock }"/> 件</span>   
					...
					<br><br><span>商品总价：</span>￥<span  id="total_prod_amt">${prod.price}</span>
					<span class="total_txt">运费：</span>￥<span id="total_yunfei"><c:out value="${prod.transFee}"/></span>
			        <input type="hidden" name="total_amt" id="total_amt" value="${prod.price }"/>
				<c:if test="${typeqty>1}">
	...
	<c:if test="${prod.manufacturer==3}">
		<ul>
			<li><h1 style="color: red">厂家售后电话:010-57732808，微信号：jlj968</h1></li>
			<li><h1 style="color: red">工作时间:9:00--17:30</h1></li>
		...
		<c:if test="${prod.prodId==4}">
		<ul>
			<li><h1 style="color: red">厂家售后电话:4006075315</h1></li>
			<li><h1 style="color: red">工作时间:8:00～11：30 13：30～18：00</h1></li>
	...
	<c:if test="${prod.prodId==29}">
			<ul>
				<li><h1 style="color: red">厂家售后电话:010-53341760</h1></li>
				<li><h1 style="color: red">工作时间:9:00--19:30</h1></li>
				<li><img style="width: 100%" alt=""
...
//   	 	       alert("支付失败!");  
	...
	function checkProd(obj)
	{
		...
		$("#productKC").val(parseInt($(obj).attr("stock")));
	}
