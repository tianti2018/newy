...
@Repository
public class JifenUserDaoImpl extends EntityDaoImpl <JifenUser, Integer> implements JifenUserDao {
	...
	public List<JifenUser> findAllUserByNowDate() throws ParseException {
		...
		List<JifenUser> list = getHibernateTemplate().findByCriteria(dc);
		return list;
	}
